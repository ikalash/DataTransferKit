...
TEUCHOS_UNIT_TEST( VolumeSourceMap, one_to_many_parallel )
{
    ...
    if ( global_comm->getRank() == 0 )
    {
        ...
        source_evaluator =
            Teuchos::rcp( new MyEvaluator( geom_gids, source_comm ) );
    }
    ...
    Teuchos::RCP<FieldManager<FieldType>> target_space_manager = Teuchos::rcp(
    ...
    if ( global_comm->getRank() == 0 )
    {
        TEUCHOS_TEST_FLOATING_EQUALITY( target_data[0], 1.0, tol, std::cout,
                                        success );
        TEUCHOS_TEST_FLOATING_EQUALITY( target_data[1], 0.0, tol, std::cout,
                                        success );
    }
    else if ( global_comm->getRank() == 1 )
    {
        TEUCHOS_TEST_FLOATING_EQUALITY( target_data[0], 2.0, tol, std::cout,
                                        success );
        TEUCHOS_TEST_FLOATING_EQUALITY( target_data[1], 0.0, tol, std::cout,
                                        success );
    }
    ...
    {
        TEUCHOS_TEST_FLOATING_EQUALITY( target_data[0], 3.0, tol, std::cout,
                                        success );
        TEUCHOS_TEST_FLOATING_EQUALITY( target_data[1], 0.0, tol, std::cout,
                                        success );
    }
    else if ( global_comm->getRank() == 3 )
    {
        TEUCHOS_TEST_FLOATING_EQUALITY( target_data[0], 3.0, tol, std::cout,
                                        success );
        TEUCHOS_TEST_FLOATING_EQUALITY( target_data[1], 4.0, tol, std::cout,
                                        success );
    }
